...
static inline int
z32__encode (const uint8_t *buffer, size_t buffer_len, utf8_t *string, size_t *string_len) {
...
static inline int
z32__decode (const utf8_t *string, size_t string_len, uint8_t *buffer, size_t *buffer_len) {
...
z32_encode (const uint8_t *buffer, size_t buffer_len, utf8_t *string, size_t *string_len) {
  return z32__encode(buffer, buffer_len, string, string_len);
}

inline int
z32_decode (const utf8_t *string, size_t string_len, uint8_t *buffer, size_t *buffer_len) {
  return z32__decode(string, string_len, buffer, buffer_len);
}
